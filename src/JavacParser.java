...
//          System.out.println("doc comment = ");System.out.println(dc);//DEBUG
            ...
            System.out.println("size:"+docComments.size());
            System.out.println("value:"+docComments.get(tree)); 
        }
    }
...
/* ---------- parsing -------------- */
    ...
    Name ident() {
        ...
        if (S.token() == IDENTIFIER) {
            Name name = S.name();
            System.out.print("variable=(name:"+name.toString()+" and BeginPos:"+S.pos()+" and EndPos:"+S.endPos()+")\n\n");
            S.nextToken();
            return name;
...
//where
                ...
                case DOT:
                    ...
                    if ((mode & EXPR) != 0) {
                        ...
                        case CLASS:
                            ...
                            System.out.println("CLASS"+t.toString());
                            S.nextToken();
                            break loop;
                        case THIS:
                            if (typeArgs != null) return illegal();
    ...
    JCBlock block(int pos, long flags) {
        ...
        char[] st = t.toString().toCharArray();
        ...
        System.out.println("block=(BeginPos:"+pos+ " and EndPos:"+t.endpos+")");    
...
//todo: skip to anchor on error(?)
    ...
    public JCStatement parseStatement() {
        ...
        case FOR: {
        	 //System.out.println("pos="+pos+",token="+S.token());
            S.nextToken();
            accept(LPAREN);
            ...
            if (inits.length() == 1 &&
                ...
                System.out.println("for-loop=(BeginPos"+body.pos+")");
        ...
        case WHILE: {
            ...
            System.out.println("while-loop=(BeginPos"+body.pos+")");
            System.out.println(body);
        ...
        case DO: {
            ...
            S.nextToken();
            JCStatement body = parseStatement();
            System.out.println("------------------do-while-loop begin-----------------------");
            System.out.println("do-while-loop=(BeginPos"+body.pos+")");
            System.out.println(body);
    ...
    List<JCCase> switchBlockStatementGroups() {
        ...
        while (true) {
            ...
            case CASE: {
                ...
                System.out.println("CASE=(BeginPos:"+c.pos+")");
    ...
    JCClassDecl classDeclaration(JCModifiers mods, String dc) {
        ...
        System.out.println("class=(classname="+result.name+" and BeginPos"+result.getStartPosition()+")");
    ...
    JCTree methodDeclaratorRest(int pos,
        ...
        System.out.println("function=(name:"+result.name+" and BeginPos:"+result.pos+" and EndPos:"+body.endpos+")");
