...
public class Scanner implements Lexer {
        ...
        do {
            ...
            default:
                ...
                if (!isJavaIdentifierPart) {
                    name = names.fromChars(sbuf, 0, sp);
                    //System.out.println("isNotIden:"+name+"\n");
                    token = keywords.key(name);
                    return;
                }
            }
                ...
                case '/':
                    ...
                    if (ch == '/') {
                        ...
                        if (bp < buflen) {
                            ...
                            //System.out.println("Single-Line Comments:"+sb);
                        }
                        break;
                    } else if (ch == '*') {
                        scanChar();
                            ...
                            while (bp < buflen) {
                                if (ch == '*') {
                                    ...
                                    if (ch == '/') 
                                    	...
                                    	//System.out.println("multiline comment："+sb);
                                    	break;
                                } else {
                                	sb.append(ch);
                                    scanCommentChar();
     ...
     */
    public Token token() {
    	//System.out.println("Token:"+token.toString()+"*tokenName:"+token.name());
        return token;
    }
